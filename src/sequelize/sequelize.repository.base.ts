...
> implements EntityCrudRepository<T, ID, Relations>
{
   ...
   *
   * @deprecated To exclude hidden props from a model call the `.toJSON()` method on it
   * Which is available for models returned from `create`, `find` or `findById` method.
